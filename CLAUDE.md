...
The root checkout at `/home/user/ecm/enhancedchannelmanager` is on the `dev` branch. All edits, builds, and deploys happen from here directly — there is no separate worktree.
