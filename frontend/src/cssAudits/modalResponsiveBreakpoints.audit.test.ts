...
const EXPECTED: MediaBlock[] = [
  ...
  { file: 'channelPipeline/EventSyncReviewQueue.css', query: '(max-width: 600px)', selectors: ['.event-sync-review-bulk-toolbar'] },
  { file: 'channelPipeline/PipelineYamlEditor.css', query: '(max-width: 768px)', selectors: ['.pipeline-yaml-controls label'] },
...
const EXPECTED_MODAL_STYLE_FILES = [
  ...
  'channelPipeline/EventSyncAutoSyncFixDialog.css', 'channelPipeline/EventSyncReviewQueue.css',
  'channelPipeline/EventSyncRuleEditor.css',
  'channelPipeline/PipelineYamlEditor.css',
