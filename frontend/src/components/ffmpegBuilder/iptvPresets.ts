...
export const IPTV_INPUT_OPTIONS: Record<string, string> = {
    reconnect: '1',
...
export const IPTV_GLOBAL_OPTIONS: Record<string, string> = {
    fflags: '+genpts+discardcorrupt',
    err_detect: 'ignore_err',
};

// Common IPTV stream mappings (first video + first audio)
export const IPTV_STREAM_MAPPINGS: FFMPEGBuilderState['streamMappings'] = [
...
export const IPTV_PRESETS: IPTVPreset[] = [
    {
        id: 'passthrough',
        name: 'Pass-through',
