...
> **Status:** Stub. The articles below are placeholders. The deep technical reference already exists at [`docs/normalization.md`](../../normalization.md); this section will be the operator-task wrapper around it, not a duplicate.
