...
| [Debugging Rules](debugging-rules.md) | How to diagnose "my rule didn't fire" using the rule analyzer and server-filtered per-run execution logs: the 8 finding codes, worked examples, and when to use the analyzer vs. a dry-run. |
